...
title = Label(root,text="CAR RENTAL RECEIPT",foreground="black",font=("Calibri Bold",30),anchor=N).grid(row=0,column=2)
...
subhd1 = Label(root,text="COMPANY INFO",foreground="black",font=("Calibri Bold",16)).grid(row=7,column=1)
...
subhd2 = Label(root,text="LESSEE INFO",foreground="black",font=("Calibri Bold",16)).grid(row=7,column=4)
...
V = Label(root,text="VEHICLE INFORMATION",foreground="black",font=("Calibri Bold",26)).grid(row=16,column=2)
...
VIN = Label(root,text="VIN",foreground="black",font=("Calibri Bold",16)).grid(row=50,column=0)
cd = Label(root,text="COST/DAY",foreground="black",font=("Calibri Bold",16)).grid(row=50,column=1)
of = Label(root,text="OF DAYS#",foreground="black",font=("Calibri Bold",16)).grid(row=50,column=2)
ac = Label(root,text="ADDITIONAL COST",foreground="black",font=("Calibri Bold",16)).grid(row=50,column=3)
lc = Label(root,text="LINE COST",foreground="black",font=("Calibri Bold",16)).grid(row=50,column=4)
pm = Label(root,text="PAYMENT METHOD->",foreground="black",font=("Calibri Bold",14)).grid(row=57,column=0)
...
msg=Button(root, text='SUBMIT',width=20,bg='red').grid(row=63,column=2)
